...
public class JudgerService {
    ...
    public String judge(String testCaseFile, JudgeDetail judgeDetail, int problemId) {
        ...
        redisUtil.hPut("judge", uuid, new Gson().toJson(new com.ooad.oj_backend.mybatis.entity.Result(uuid, System.currentTimeMillis(), userId, problemId, judgeDetail.code)));
